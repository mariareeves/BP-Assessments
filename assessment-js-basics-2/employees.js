...
class Manager extends Employee {
    ...
    getEmployees() {
        ...
        // using the join method so all the elements of the array will become a single string, then the names of the employees will be separated by a comma followed by a space.
    }
