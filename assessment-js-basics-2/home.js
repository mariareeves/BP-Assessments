...
const canWeDeliver = (zipCode) => {
    if (deliveryAreaZipCodes.indexOf(zipCode) !== -1) {
        ...
        /* 'indexOf' method method returns the index of the element in the array,
        or -1 if the element is not found. However, in JavaScript, -1 is considered a truthy value, that is why we need to specify that is NOT equal to -1 so it means that it if different than -1 the zipCode exist in the array  */
...
//     }
// }
// console.log(canWeDeliverThree(84606))
